...
<#
    ...
    .Parameter Algorithm
        Mandatory. Algorithm to use when generating the hash. Example SHA256
    .Notes
        Version: 1.0
        History:
    .Example
        Compare-FileHash -File file.txt -originalhash 186F5AC26F4E9B12F861485485080A30BABA6F82 -Algorithm SHA256
#>
Param(
...
$fileHash = Get-FileHash -Algorithm $algorithm $fileName | ForEach-Object { $_.Hash} |  Out-String
